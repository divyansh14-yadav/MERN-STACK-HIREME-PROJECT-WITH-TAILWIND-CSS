...
const DetaildService = () => {
  ...
  const handleShowDeletePortfolio = () => {
            ...
            <div className="xl:w-[60%] w-full mt-12">
              ...
              <div className="mt-8 border-20 border-[#fff] bg-white">
                <Slider
                  ...
                  slidesToShow={1}
                >
                  {serviceDetaildList?.serviceImage?.map((imgd, imgIndex) => (
                    <img
                      key={imgIndex}
                ...
                <div className="flex gap-5">
                  {serviceDetaildList?.serviceImage?.map((imgds, imgIndex) => (
                    <img
              ...
              {/* <div className="mt-6">
                <div className="xl:flex xl:gap-2 grid grid-cols-2 gap-5 xl:pt-3 pt-0 xl:pb-3 pb-0 xl:pl-3 pl-0 bg-white rounded-xl">
                  {headings.map((heading, index) => (
                    <button
                      key={index}
                      className={`xl:px-4 px-4 xl:py-2 py-2 xl:text-md text-md font-semibold rounded-4xl border-1 border-[#f78318] ${
                        activeTab === index
                ...
                <div className="mt-4 p-4 bg-white shadow-md rounded-lg">
                  {activeTab === 0 && (
                    <p className="text-start text-[#5c5c5c]">
                      {serviceDetaildList?.about_Gig || "No data available."}
                    </p>
                  )}
                  {activeTab === 1 && (
                    <p className="text-start text-[#5c5c5c]">
                            ...
                            <div className="p-4">
                              ...
                              <div className="flex justify-between mt-5">
                                ...
                                <div className="capitalize leading-loose text-[#f78318] font-medium">
                                  <p>{basicPlans.b_vector_file}</p>
                                  <p>{basicPlans.b_printable_file}</p>
                                  <p>{basicPlans.b_mockup}</p>
                                  <p>{basicPlans.b_source_file}</p>
                                  <p>{basicPlans.b_social_media_kit}</p>
                                  <p>{basicPlans.b_number_of_concept}</p>
                                  <p>{basicPlans.b_revisions}</p>
                                </div>
                              </div>
                              <div>
                              {token && authId !== serviceDetaildList.authId._id && (
  <>
    <button
      onClick={handleShowDeletePortfolio}
      type="submit"
    ...
    >
                      ...
                      {serviceDetaildList?.Standard_price?.length ? (
                        serviceDetaildList?.Standard_price?.map(
                          (basicPlans, index) => (
                            <div className="p-4">
                              <div className="flex justify-between mt-5 font-bold">
                                <h1 className="mt">{basicPlans.s_Name}</h1>
                                <p className="text-[1.1rem]">
                                  {"$ " + basicPlans.s_price}
                                </p>
                              </div>
                              <p className="mt-5 text-[0.875rem] font-semibold text-[#00000080]">
                                {basicPlans.s_description}
                              </p>
                              <div className="flex justify-between mt-5">
                                <div className=" font-medium leading-loose text-[#00000080]">
                                  <p>Vector file :</p>
                                ...
                                <div className="capitalize leading-loose text-[#f78318] font-medium">
                                  <p>{basicPlans.s_vector_file}</p>
                                  <p>{basicPlans.s_printable_file}</p>
                                  <p>{basicPlans.s_mockup}</p>
                                  <p>{basicPlans.s_source_file}</p>
                                  <p>{basicPlans.s_social_media_kit}</p>
                                  <p>{basicPlans.s_number_of_concept}</p>
                                  <p>{basicPlans.s_revisions}</p>
                                </div>
                              </div>
                              <div>
                                <button
                      ...
                      {serviceDetaildList?.Premium_price?.length ? (
                        serviceDetaildList?.Premium_price?.map(
                          (basicPlans, index) => (
                            <div className="p-4">
                              <div className="flex justify-between mt-5 font-bold">
                                <h1 className="mt">{basicPlans.p_Name}</h1>
                                <p className="text-[1.1rem]">
                                  {"$ " + basicPlans.p_price}
                                </p>
                              </div>
                              <p className="mt-5 text-[0.875rem] font-semibold text-[#00000080]">
                                {basicPlans.p_description}
                              </p>
                              <div className="flex justify-between mt-5">
                                <div className=" font-medium leading-loose text-[#00000080]">
                                  <p>Vector file :</p>
                                ...
                                <div className="capitalize leading-loose text-[#f78318] font-medium">
                                  <p>{basicPlans.p_vector_file}</p>
                                  <p>{basicPlans.p_printable_file}</p>
                                  <p>{basicPlans.p_mockup}</p>
                                  <p>{basicPlans.p_source_file}</p>
                                  <p>{basicPlans.p_social_media_kit}</p>
                                  <p>{basicPlans.p_number_of_concept}</p>
                                  <p>{basicPlans.p_revisions}</p>
                                </div>
                              </div>
                              <div>
                                <button
      ...
      <div className="mt-20 pb-20 xl:w-[53.5%] w-full xl:ml-20 bg-[#f9f9f9] shadow-2xl">
      ...
      <Dialog    open={openModalDeletePortfolio}
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4 text-center">
          <DialogPanel className="relative transform overflow-hidden rounded-xl bg-white text-left shadow-lg transition-all sm:my-8 sm:w-full sm:max-w-md">
                ...
                <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-orange-100 sm:mx-0 sm:h-10 sm:w-10">
                  ...
                  >
                    <path
                      ...
                      d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.375 1.943 3.375h14.71c1.726 0 2.813-1.875 1.943-3.375a5.53 5.53 0 01-4.304-1.365 5.53 5.53 0 01-4.304 1.365c-.866 1.5.217 3.375 1.943 3.375h14.71c1.726 0 2.813-1.875 1.943-3.375a5.53 5.53 0 01-4.304-1.365 5.53 5.53 0 01-4.304 1.365"
                    />
                  </svg>
                </div>
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="mt-4 text-gray-500 text-sm">
                      Are you sure you want to proceed with this order? Please double-check your quote.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            <DialogPanel className="relative w-full max-w-lg transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all p-6">
              ...
              <div className="max-w-3xl mx-auto rounded-4xl p-6 bg-gray-50 min-h-screen">
                <div>
