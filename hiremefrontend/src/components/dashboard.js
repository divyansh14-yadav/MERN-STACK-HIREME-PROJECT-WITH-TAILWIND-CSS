...
import PaymentDeposit from "./payments/paymentDeposit";
        ...
        <div>
          ...
          <div className="w-[80%] mt-10 m-auto flex flex-col md:flex-row gap-8 pb-20">
            <div className="w-full md:w-[50%] bg-gradient-to-r rounded-md p-4 from-orange-800 pb-10 via-orange-800 to-orange-800">
              <p className="mt-5 text-[1.1rem] font-medium text-start text-white">
                Balance
              </p>
              <p className="mt-2 text-[40px] text-[#fff] text-start font-bold">
                $
                {dashboardData.totalDepositAmount
                  ? dashboardData.totalDepositAmount + ".00"
                  : "hello "}
              </p>
              <p className="mt-3 text-[1rem] text-[#fff] text-start">
                You are able to use your balance to purchase any gig or you can
                withdraw the balance as well.
              </p>
              <div className="flex gap-5 w-[50%] mt-10 justify-start">
                <button
                  type="submit"
                  className="bg-[#12d001] p-1.5 text-white font-medium rounded-[5px] w-[120px] text-[13px] cursor-pointer"
                  onClick={() =>
                    navigate("/user/deposit", { state: { dashboardData } })
                  }
                >
                  Deposit
                </button>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center w-full">
              <div className="w-full md:w-[50%]">
                <div className="w-full p-11 bg-white text-start rounded-md">
                  <div className="flex justify-between">
                    ...
                    <Link
                      to="/user/gigs"
                      className="border-1 text-center p-[1.5px] w-18 rounded-sm text-sm text-neutral-400"
                    >
                      View All
                    </Link>
                  </div>
              ...
              <div className="w-full md:w-[50%]">
                <div className="w-full p-11 bg-white text-start rounded-md">
                  <div className="flex justify-between">
                    <p className="text-[1.1rem] text-[#495463]">
                      Total Projects
                    </p>
                    <Link
                      to="/user/projects"
                ...
                <div className="mt-6 w-full p-11 bg-white text-start rounded-md">
                  ...
                  <p className="text-[1.3rem] font-bold text-[#495463] mt-2">
                    {dashboardData.totalServices
                      ? dashboardData.totalCreatedTask + " task"
                      : 0}
                  </p>
                </div>
              </div>
