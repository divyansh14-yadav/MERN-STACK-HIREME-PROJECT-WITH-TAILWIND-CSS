...
const BasicInfo = () => {
  ...
  const handleShow = (index = null) => {
    if (index !== null && folio[index]) {
      ...
      setPortfolioImage(portfolioToEdit?.portfolioImage || "");
  ...
  return (
    <div className="bg-[#eef2f8]">
      <Nav userDetails={userDetails.authProfile} />
      <OtherNav />
                  ...
                  <form onSubmit={handleUpdateUserData}>
                    ...
                    <div className="text-start w-[95%] m-auto mt-6">
                      ...
                      <div className="flex justify-end mt-8">
                        <button className="border-2 border-[#f78318] bg-[#f78318] text-white font-bold text-[1rem] px-6 py-2 rounded-md hover:bg-[#e0720f] transition">
                          Submit
                        </button>
                      </div>
                    </div>
              ...
              {activeTab === 1 && (
                <div className="text-start text-[#5c5c5c] overflow-x-auto">
                  <div className="flex justify-between items-center border-b pb-4 min-w-[700px]">
                    ...
                    <button
                      className="border-2 border-[#f78318] text-[1rem] xl:p-2 p-1 font-bold text-white bg-[#f78318] rounded-md"
                ...
                <div className="text-start text-[#5c5c5c] overflow-x-auto">
                  <div className="min-w-[700px]">
                    <div className="flex justify-between items-center border-b pb-6">
                      ...
                      <button
                        className="border-2 border-[#f78318] xl:text-[1rem] text-[0.875rem] xl:w-[10%] w-[15%] p-1 font-bold text-white bg-[#f78318] rounded-md"
                        onClick={handleShow}
                      >
                        + Add New
                      </button>
                          ...
                          {folio.length > 0 ? (
                            folio.map((allFolio, index) => (
                              ...
                              >
                                ...
                                <td className="px-6 py-4">
                                  <div className="border w-8 h-8 border-[#0000001a] rounded-full flex items-center justify-center">
                                    <FontAwesomeIcon
      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto overflow-x-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <div className="bg-white px-4 pt-4 pb-3 sm:p-4 sm:pb-3 min-w-[280px]">
                <div>
                  <div className="mt-3 text-center sm:mt-0 sm:text-left">
                    <DialogTitle
                      as="h3"
                      className="text-base text-[1.25rem] font-bold text-[#495463]"
                    >
                      Add New Portfolio
                    </DialogTitle>
              ...
              {/* Buttons Section */}
              <div className="flex justify-end gap-4 mr-6 pb-5">
                <button
                  type="button"
                  onClick={() => handleClose()}
                  className="border-2 border-gray-300 text-gray-700 px-6 py-2 text-[1rem] font-bold rounded-md hover:bg-gray-100 transition-all"
                >
                  Cancel
                </button>
                ...
                <button
                  ...
                  className="border-2 border-[#f78318] bg-[#f78318] text-white px-6 py-2 text-[1rem] font-bold rounded-md hover:bg-[#f78318]/90 transition-all"
                >
                  Submit
                </button>
              </div>
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button
                  type="button"
                  onClick={() => handleDeletePortfolio(folio._id)}
                  className="inline-flex w-full justify-center rounded-md bg-red-600 px-6 py-2 text-sm font-bold text-white hover:bg-red-500 sm:ml-3 sm:w-auto transition-all"
                >
                  Yes, Delete
                </button>
                ...
                <button
                  ...
                  className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-6 py-2 text-sm font-bold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-100 sm:mt-0 sm:w-auto transition-all"
                >
                  Cancel
                </button>
              </div>
