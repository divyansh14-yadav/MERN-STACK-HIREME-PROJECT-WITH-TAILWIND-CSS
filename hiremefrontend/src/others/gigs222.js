        ...
        <div className="bg-[#eef2f8]">
            ...
            <div className="w-[80%] mt-10 m-auto rounded-md bg-white">
                <div className="flex justify-between items-center border-b-1 border-[#0000001a] p-4 pb-5">
                    ...
                    <button className="border-2 border-[#f78318] text-[1rem] p-2 font-bold text-white bg-[#f78318] rounded-md" onClose={() => setOpen(false)}>
                        + Create Gigs
                    </button>
                </div>
                <div>
                        ...
                        {activeStep === steps.length ? (
                            ...
                            <>
                                    ...
                                    {activeStep === 5 && (
                                        <div>
                                            <div className="flex justify-between items-center border-b-1 pb-4 border-[#0000001a]">
                                                ...
                                                <button onClick={handleServiceCreate} className="border-2 mt-4 p-2 bg-[#f78318] text-white font-semibold text-[0.875rem] rounded-md cursor-pointer" type="submit">Save as Draft</button>
                                            </div>
                                ...
                                <Box sx={{ display: "flex", justifyContent: "space-between", marginTop: "60px" }}>
                                    ...
                                    <Button onClick={handleServiceCreate} variant="contained" sx={{ bgcolor: "#f78318", "&:hover": { bgcolor: "#d96c14" } }}>
...
//                     <h1 className="text-[1rem] text-[#495463] font-bold">My Gigs</h1>
//                     <button
//                         className="border-2 border-[#f78318] text-[1rem] p-2 font-bold text-white bg-[#f78318] rounded-md"
